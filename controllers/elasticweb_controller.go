...
//+kubebuilder:rbac:groups=elasticweb.my.domain,resources=elasticwebs,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=elasticweb.my.domain,resources=elasticwebs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=elasticweb.my.domain,resources=elasticwebs/finalizers,verbs=update
