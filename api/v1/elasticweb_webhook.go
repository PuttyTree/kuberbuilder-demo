...
//+kubebuilder:webhook:path=/mutate-elasticweb-my-domain-v1-elasticweb,mutating=true,failurePolicy=fail,sideEffects=None,groups=elasticweb.my.domain,resources=elasticwebs,verbs=create;update,versions=v1,name=melasticweb.kb.io,admissionReviewVersions=v1
...
func (r *ElasticWeb) Default() {
  ...
  if r.Spec.TotalQPS == nil {
    r.Spec.TotalQPS = pointer.Int32Ptr(1300)
...
//+kubebuilder:webhook:path=/validate-elasticweb-my-domain-v1-elasticweb,mutating=false,failurePolicy=fail,sideEffects=None,groups=elasticweb.my.domain,resources=elasticwebs,verbs=create;update,versions=v1,name=velasticweb.kb.io,admissionReviewVersions=v1
...
func (r *ElasticWeb) validateElasticWeb() error {
  ...
  if *r.Spec.SinglePodQPS > 1000 {
    ...
    return apierrors.NewInvalid(
      schema.GroupKind{Group: "elasticweb", Kind: "ElasticWeb"},
      r.Name,
      allErrs)
  } else {
